...
public class ZemestanDbContext :
    AbpDbContext<ZemestanDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public ZemestanDbContext(DbContextOptions<ZemestanDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(ZemestanConsts.DbTablePrefix + "YourEntities", ZemestanConsts.DbSchema);
